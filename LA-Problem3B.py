...
def aStar(gp):
    ...
    while frontier:
        # gbfs called heuristic func to sort no other change than ufs
        frontier.sort(key=lambda node: node.path_cost +
                      heuristicVal[node.state])
...
print('===================================')
print ( " Result of aStar " )
print('===================================')
resultnode=aStar(graphp1)
